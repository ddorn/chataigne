...
def test_to_openai(messages, expected_result):
    result = MessageHistory(messages).to_openai()
...
def test_to_openai_fails(messages, expected_result):
    result = MessageHistory(messages).to_openai()
    assert result == expected_result
...
def test_openai_accepts_messages(messages):
    messages = messages[1]
